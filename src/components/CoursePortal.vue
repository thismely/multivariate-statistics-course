...
<template>
  <div class="course-portal" :class="{ 'course-portal-space': routeName === 'space' }">
    ...
    <main v-else class="course-main">
      ...
      <section v-else-if="routeName === 'about'" class="course-page about-page"><div class="page-intro"><span class="course-kicker">ABOUT THIS COURSE</span><h1>关于课程</h1><p>《多元统计分析》开放式数字课程，以三维知识空间为核心导航，将课程内容、Python 实验、案例数据与可追溯资源连接起来。</p><p>在大数据时代，经济金融活动产生了海量数据，传统单变量统计分析方法已经难以揭示复杂经济现象背后的规律。多元统计分析是研究多个变量之间相互关系的重要工具，是现代数据科学、金融工程、人工智能和商业分析的重要理论基础。课程内容涵盖聚类分析、主成分分析、因子分析、判别分析、典型相关分析、对应分析等经典多元统计方法，同时结合 Python 数据分析平台实现建模与应用。课程体系主要包括多元数据处理、可视化分析、综合评价、聚类分析、主成分分析、因子分析、对应分析、典型相关分析、相关与回归分析以及扩展线性模型等内容。课程突出“理论+实践+应用”的教学理念，以真实经济金融案例为背景，引导学生利用 Python 完成数据处理、模型构建、结果解释和决策分析全过程。</p></div><div class="about-grid"><article><span class="about-icon"><Target :size="20" /></span><h2>学习目标</h2><p>理解多元数据中的结构、关系与不确定性，能够在问题、数据、方法和解释之间建立清晰的分析链条。</p></article><article><span class="about-icon"><UsersRound :size="20" /></span><h2>适用对象</h2><p>适合正在学习多元统计分析、希望用 Python 完成数据分析练习，或需要从方法边界出发阅读案例的学习者。</p></article><article><span class="about-icon"><Github :size="20" /></span><h2>开放项目</h2><p>课程采用 Vue、Vite、Three.js 与 Pinia 构建，适合在 GitHub Pages 上持续维护与公开访问。</p><a class="course-text-link" href="https://github.com/thismely/multivariate-statistics-course" target="_blank" rel="noopener">查看 GitHub 项目<ExternalLink :size="14" /></a></article><article><span class="about-icon"><Info :size="20" /></span><h2>资源说明</h2><p>公开清单仅收录适合发布的课程资源。教材使用范围已由课程提供者确认，本版完整教材保留书目信息与阅读提示。学生信息和系统敏感信息不进入公开站点。</p></article></div></section>
